...
This is a tool and method for forecasting adult salmon returns using PIT tag data. The app was available [here](https://like-a-sturgeon.shinyapps.io/iciclecreekforecast/) but it is currently under construction.
