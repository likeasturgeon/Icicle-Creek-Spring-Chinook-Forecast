...
Table 4 shows the tendency of this forecast to under predict by an average `r paste(round(mean( predicted$'Percent Diff' ), 1), "%" , sep = "")`. This may be explained by research showing that PIT tagged fish have lower smolt to adult return rates (Knudsen, 2009, McDonald et al 2003, Prentice 1994). Sliding PIT ratios have been documented at other hatcheries with the Leavenworth Complex as well. We see a much larger deviation in 2015 when Icicle Creek. The exact cause isn't known yet but could be related to record high air and water temperatures in Icicle Creek that year. This was also one of the lowest water years in history for Icicle Creek. Other explanations could include an increase in out of basin strays to Icicle Creek, reduced angling effort, or unsuccessful angling. More research and subsequent year's data may better explain the discrepancy. 
